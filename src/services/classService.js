...
function createMessage(classId, authorId, text) {
    return __awaiter(this, void 0, void 0, function () {
        var classObj, message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.class.findUnique({ where: { id: classId } })];
                case 1:
                    classObj = _a.sent();
                    if (!classObj) {
...
function getClass(classId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.class.findUnique({
                        where: { id: classId },
                        include: {
                            school: true,
                            enrollments: {
